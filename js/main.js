 ...
 * string (currently 20) — GitHub Pages sets no explicit Cache-Control, so
 ...
 * needs `v=20` bumped everywhere in the same commit — every occurrence,
 * across all 6 HTML files and every internal import — or the fix won't
 * actually reach anyone with a warm cache.
 */
import { capabilities, canUseWebGLScene } from './core/device.js?v=20';
import { initSmoothScroll } from './core/smooth-scroll.js?v=20';
import { initCursor } from './core/cursor.js?v=20';
import { initNav, initScrollProgress, markActiveLink } from './core/nav.js?v=20';
import { initReveals, clearRevealTriggers } from './core/reveal.js?v=20';
import { initTransitions } from './core/transitions.js?v=20';
import { initMailtoCopy } from './core/toast.js?v=20';
import { initLightbox } from './core/lightbox.js?v=20';
import { initFallback, initFlowyVideo } from './three/fallback.js?v=20';

import * as homePage from './pages/home.js?v=20';
import * as aboutPage from './pages/about.js?v=20';
import * as capabilitiesPage from './pages/capabilities.js?v=20';
import * as whyIndrevaPage from './pages/why-indreva.js?v=20';
import * as visionPage from './pages/vision.js?v=20';
import * as contactPage from './pages/contact.js?v=20';
...
async function boot() {
  ...
  initScrollProgress();
  initMailtoCopy();
  // Delegated from document, so the SPA content swaps never rebind it.
  initLightbox();
  ...
  if (canUseWebGLScene()) {
    try {
      sceneModule = await import('./three/scene.js?v=20');
