...
import { createMonogram, applyDispersion } from './monogram.js?v=10';
import { getWaypoint, VISION_STAGES } from './waypoints.js?v=10';
import { capabilities } from '../core/device.js?v=10';
