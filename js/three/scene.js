...
import { createMonogram, applyDispersion } from './monogram.js?v=25';
import { getWaypoint, VISION_STAGES } from './waypoints.js?v=25';
import { capabilities } from '../core/device.js?v=25';
