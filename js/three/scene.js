...
import { createMonogram, applyDispersion } from './monogram.js?v=9';
import { getWaypoint, VISION_STAGES } from './waypoints.js?v=9';
import { capabilities } from '../core/device.js?v=9';
